...
Click on the fullscreen icon to increase the resolution of the interactive image below and then click on the plus icon to open sections with more information. (The table containing this information can be downloaded [here](Adult learning principles in practice.pdf).)
